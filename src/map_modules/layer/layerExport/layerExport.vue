        ...
        <div v-if="!mobileLayout" dir="ltr" style=" height: 100%" class="pa-2 rounded-lg " id="editLayerWindow">
            <Splitter style="height: 100%" class="ma-0 pa-0 rounded-lg ">
                <SplitterPanel
                    ...
                    <v-fade-transition>
                        <main-export-layer :layerId="selectedLayer.id" v-if="selectedLayer"/>
...
<script lang="ts">
    ...
    import mainExportLayer from "@/map_modules/layer/layerExport/layerExportComponent/main.vue"
    import {useRoute, useRouter} from "vue-router";

    export default defineComponent({
        name: "DeleteLayer",
        components: {Splitter, SplitterPanel, layerTree, mainExportLayer},
