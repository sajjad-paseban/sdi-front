        ...
        <div
            ...
            <v-row class="ma-0 pa-2" align="center" style="height: 100%">
                ...
                >
                    ...
                    <searchInLayer @saveSearch="getSearchLayer"></searchInLayer>
...
<script lang="ts">
    ...
    import searchInLayer from  '@/map_modules/layer/addLayer/addLayerBySearchInLayer/search.vue'
    import {resultSimpleLayerSearchSd} from "@/api/layer/SD.Models/resultSimpleLayerSearch.sd";


    export default defineComponent({
        name: "searchLayerConfig",
        components: {SimpleDialog,searchInLayer},
        setup() {
            const {list, layerGroupList} = layerGroupFunctions()
            const{addLayerBySearchInLayer} = layer_functions()
            ...
            return {
                layerGroupList, initData, AddLayerForm, nameRule,layerTypesList,addLayerBySearchInLayer
            }
        },
        data() {
            return {
                layer: {} as SearchInLayerInterface,
                makeLayerDialog:false,
                show: false,
                layerData :null as null|resultSimpleLayerSearchSd
            };
        },
        props: {},
        methods: {
                ...
                if (this.AddLayerForm) {
                    ...
                    if (res.valid) {
                        if (this.layerData){
                            ...
                            const response = await this.addLayerBySearchInLayer(this.layer)
            ...
            getSearchLayer(data:resultSimpleLayerSearchSd){
