            ...
            <v-form ref="addBaseStyleForm" class="myForm">
                <v-row class="ma-0 pa-0" justify="center">
                    <v-col cols="12" sm="11">
                        ...
                        <v-row v-if="layerType ===layerTypesObjects.Polygon||layerType ===layerTypesObjects.MultiPolygon" class="ma-0 pa-0 mt-2 pb-2 rounded-lg elevation-2"
                        ...
                        <v-row v-if="layerType ===layerTypesObjects.Polygon||layerType ===layerTypesObjects.MultiPolygon ||layerType ===layerTypesObjects.Line||layerType ===layerTypesObjects.MultiLine"
                        ...
                        <v-row v-if="layerType ===layerTypesObjects.Point||layerType ===layerTypesObjects.MultiPoint" class="ma-0 pa-0 rounded-lg">
                            <v-col
                                    cols="12"
                                    md="6"
                ...
                <v-row class="ma-0 pa-0  pb-4 pt-2" justify="center">
                    <v-col cols="12" sm="11">
                        <v-row v-if="!advanceStyle" class="ma-0 pa-0 ">
...
<script lang="ts">
    ...
    import {Layer_types, LayerFieldTypes} from "@/models/Layer.Interface";
    ...
    export default defineComponent({
        ...
        data() {
            return {
                ...
                layerTypes: Object.values(Layer_types),
                layerTypesObjects : Layer_types,
            ...
            async saveStyleToLayer() {
                if (this.addBaseStyleForm) {
                    ...
                    if (res.valid) {
                        const data: BaseStyleInterface = {
                            ...this.style,
                            name: String(this.layerId) + '_base',
                            max_zoom: this.style.zoom[1],
                            min_zoom: this.style.zoom[0],
                            geo_type: this.layerType,
                            for_layer: true,
                ...
                if (this.addBaseStyleForm) {
                    ...
                    if (res.valid) {
                        const data: BaseStyleInterface = {
                            ...
                            name: this.layerId ? String(this.layerId) + '_base' : this.style.name,
                            max_zoom: this.style.zoom[1],
                            min_zoom: this.style.zoom[0],
                            geo_type: this.layerType
                        }
                        console.log(data)
                        const response = await this.editBaseModelStyle(data, this.id)
                        if (response) {
                            this.$toast.add({
                                group: 'tr',
                                life: 7000,
            ...
            async saveAdvanceStyle() {
                if (this.addBaseStyleForm) {
                    ...
                    if (res.valid) {
                        ...
                        this.$emit('saveAdvanceStyle', data)
                        this.$emit('hide', false)
                    }
                }
            }
        ...
        watch: {
            ...
            async id() {
                if (this.id !== 0) {
                    await this.getItemBaseStyle(this.id)
                    if (this.baseStyleItem && this.baseStyleItem.max_zoom && this.baseStyleItem.min_zoom) {
                        this.style = {
                            ...this.baseStyleItem,
                            zoom: [this.baseStyleItem.min_zoom, this.baseStyleItem.max_zoom]
                        ...
                        if (this.baseStyleItem.geo_type && this.baseStyleItem.geo_type !== this.layerType) {
                            this.layerType = this.baseStyleItem.geo_type
                            await this.getListBaseStyles(this.layerType)
                            this.listStyles = []
                        }
                    }
                }
            ...
            async layerType() {
                ...
                switch (this.layerType) {
                    case Layer_types.Polygon:
                        this.style.point = null
                        break;
                    case Layer_types.Line:
                        this.style.point = null
                        this.style.polygon = null
                        break;
                    case Layer_types.Point:
                        this.style.polygon = null
                        this.style.edge = null
                        break;
            ...
            styleObject() {
                ...
                if (this.styleObject) {
                    this.style = {
                        ...this.styleObject,
                        zoom: [parseInt(this.styleObject['min_zoom']), parseInt(this.styleObject['max_zoom'])],
                        name: 'test'
                    }
                }
            }
