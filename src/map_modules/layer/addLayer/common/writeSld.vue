                    ...
                    <v-row class="ma-0 pa-0 mt-n2" justify="center" align="center" style=" height: calc(100% - 40px)">
                        <v-col class="  ma-0 pa-0  " cols="12" sm="11" style="height: 100%">
                            ...
                            <v-row dir="ltr" class="ma-0 px-2 pa-2 " style="height:calc(100% - 60px);">
                                ...
                                <CodeEditor font_size="12px" style="width: 100%" :language_selector="true"
                                            :languages="[['xml', 'xml']]" v-model="sldText" value=""></CodeEditor>
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            return {nameRule, writeForm, addFileStyle, updateFileStyle}
        },
        data() {
            return {
                showDialog: false,
