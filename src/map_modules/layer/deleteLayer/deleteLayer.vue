        ...
        <div v-if="!mobileLayout" dir="ltr" style=" height: 100%" class="pa-2 rounded-lg " id="editLayerWindow">
            <Splitter style="height: 100%" class="ma-0 pa-0 rounded-lg ">
                <SplitterPanel
                    ...
                    <v-fade-transition>
                        <main-delete-layer :layerId="selectedLayer.id" v-if="selectedLayer"/>
...
<script lang="ts">
    ...
    import mainDeleteLayer from "@/map_modules/layer/deleteLayer/deleteLayerComponent/main.vue"
    import {useRoute, useRouter} from "vue-router";

    export default defineComponent({
        name: "DeleteLayer",
        components: {Splitter, SplitterPanel, layerTree, mainDeleteLayer},
