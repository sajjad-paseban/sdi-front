    ...
    <div style="height:100%;width:100%;overflow-y: auto">
        ...
        <v-fade-transition>
            <v-row v-if="initData" style="height:100%" class="ma-0 pa-2" justify="center" align="center">
                <v-col cols="12" style="height: 95%" class="rounded-lg bg-white elevation-1">
                            ...
                            <v-form class="myForm">
                                <v-row class="ma-0 pa-0">
                                    ...
                                    <v-col dir="rtl" cols="12" md="7">
                                        <v-btn style="font-size:11px" @click="dialog=true" elevation="1" size="small" color="info">انتخاب گروه
                                            بندی عکس
                                        </v-btn>
                                    </v-col>
