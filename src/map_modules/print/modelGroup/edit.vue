...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const {list,tempGroupList,getItemTempGroup,groupItem,editTempGroup} = print_functions()
            ...
            onMounted(async () => {
                ...
                if (!route.params.data) {
                    ...
                    if (typeof route.params.data === 'string') {
                        await getItemTempGroup(parseInt(route.params.data))
            ...
            return {
                nameRule, toast, myEditGroupForm, initData,activeParent,name,parent_id,tempGroupList,editTempGroup,groupItem
            }
        },
            ...
            async saveLayerGroup() {
                ...
                if (this.myEditGroupForm) {
                    ...
                    if (res.valid && this.groupItem && this.groupItem.id) {
                        ...
                        const response = await this.editTempGroup({name: this.name, parent: this.activeParent?this.parent_id:null},this.groupItem.id)
                        if (response) {
                            this.$toast.add({
                                group: 'tr',
                                life: 7000,
                                ...
                                detail: 'گروه ویرایش شد '
                            });

                            this.$router.push({name:'groupModelList'})
