                            ...
                            >
                                <v-row class="pa-0 ma-0">
                                    <v-col cols="12" md="6" lg="4" class="ma-0">
                                        <v-text-field v-model="myDataForm.topic" density="compact" variant="solo"
                                    ...
                                    <v-col cols="12" md="6" lg="4" class="ma-0">
                                        <v-text-field v-model="myDataForm.layers" density="compact" variant="solo" :rules="nameRule"
                                                      required>
                                            <template v-slot:prepend-inner>
                                                <v-icon color="primary" icon="mdi-format-color-text"/>
                                            </template>
                                    ...
                                    <v-col cols="12" md="6" lg="4" class="ma-0">
                                        <v-text-field v-model="myDataForm.styles" density="compact" variant="solo"
                                                      required>
                                            <template v-slot:prepend-inner>
                                                <v-icon color="primary" icon="mdi-format-color-text"/>
                                            </template>
                                    ...
                                    <v-col cols="12" md="6" lg="4" class="ma-0">
                                        <v-text-field v-model="myDataForm.format_option" density="compact" variant="solo"
                                                      required>
                                            <template v-slot:prepend-inner>
                                                <v-icon color="primary" icon="mdi-format-color-text"/>
                                            </template>
                                    ...
                                    <v-col cols="12" md="6" lg="4" class="ma-0">
                                        <v-text-field v-model="myDataForm.crs" density="compact" variant="solo" :rules="nameRule"
                                                      required>
                                            <template v-slot:prepend-inner>
                                                <v-icon color="primary" icon="mdi-format-color-text"/>
                                            </template>
                                    ...
                                    <v-col cols="12" md="6" lg="4" class="ma-0">
                                        <v-text-field v-model="myDataForm.user_name" density="compact" variant="solo"
                                                      required>
                                            <template v-slot:prepend-inner>
                                                <v-icon color="primary" icon="mdi-format-color-text"/>
                                            </template>
                                    ...
                                    <v-col cols="12" md="6" lg="4" class="ma-0">
                                        <v-text-field v-model="myDataForm.geo_field_name" density="compact" variant="solo"
                                                      required>
                                            <template v-slot:prepend-inner>
                                                <v-icon color="primary" icon="mdi-format-color-text"/>
                                            </template>
                                    ...
                                    <v-col cols="12">
                                        <v-text-field v-model="myDataForm.apiKey" density="compact" variant="solo"
                                                      required>
                                            <template v-slot:prepend-inner>
                                                <v-icon color="primary" icon="mdi-format-color-text"/>
                                            </template>
                                    ...
                                    <v-col cols="12" class="ma-0 textArea">
                                        <v-textarea
                                                v-model="myDataForm.wfs_address"
                                                :rules="nameRule"
                                                dir="rtl"
                                                no-resize
                                                rows="5"
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        components: {},
        setup() {
            const {getServiceTypesAction, addServiceAction, serviceTypes, checkService, getServiceVersionAction, serviceVersion} = services()
        ...
        data() {
            return {
                ...
                myDataForm: {type: 'Wms',version:'1.1.1'} as ServiceInterface,
        ...
        methods: {
            async saveService() {
                if (this.myAddService) {
                    ...
                    if (res.valid) {
                        ...
                        let response = await this.addServiceAction(this.myDataForm)
            ...
            async checkServiceAction() {
                if (this.myAddService) {
                    ...
                    if (res.valid && this.myDataForm) {
                        this.checkServiceLoading = true
                        const result = await this.checkService(this.myDataForm)
