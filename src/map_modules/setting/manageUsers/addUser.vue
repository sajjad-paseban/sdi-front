        ...
        >
            ...
            <v-row v-if="initData" class="ma-0 pa-0" justify="center">
                <v-col cols="12" md="10" class="py-2">
                    <v-form ref="myAddUserForm" class="myForm pa-2 rounded-lg elevation-2"
                            style="width: 100%; height: 100%">
                        <v-row class="ma-0 pa-0">
                            <v-col cols="12" sm="3">
                                <v-btn @click="searchUserDialog=true" variant="tonal" color="primary" class="font-weight-bold"
                                       style="height:30px;font-size:12px;width: 100%">بانک اشخاص
                                </v-btn>
                            </v-col>
                        ...
                        >
                            <v-col class="ma-0 pa-0" cols="12">
                                ...
                                <v-row class="ma-0 px-2 pa-2 textArea myTextAria">
                                    <v-textarea
                                            dir="rtl"
                                            no-resize
                                ...
                                <v-row class="pa-0 ma-0">
                                    <v-col class="ma-0 py-2 myFile" cols="6" md="4">
                                        <v-file-input
                                                label="انتخاب تصویر"
                                                chips
...
export default defineComponent({
    ...
    setup() {
        ...
        return {
            nameRule, toast, myAddUserForm, rolesWithParentName, initData, floatRule, addUserAction, phoneRule
        }
    },
    ...
    methods: {
        ...
        selectPerson(person: Person) {
            console.log(person)
            this.user.first_name = person.name
            this.user.last_name = person.last_name
            if (this.user.national_code && person.national_code){
                this.user.national_code = parseInt(person.national_code)
            }
            if (person.mobile)
                this.user.phone = person.mobile

            this.user.address = person.address
