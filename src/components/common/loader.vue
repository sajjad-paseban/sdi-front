<template>
  <div dir="ltr" style="position: absolute;z-index: 10002;width: 100%;height: 100%;background-color:rgba(255,255,255,0.62) ">
    <v-row style="height: 100%" align="center" justify="center">
      <div>
        <div style="color: rgb(var(--v-theme-primary))" class="la-ball-grid-pulse la-3x">
          <div></div>
          <div></div>
          <div></div>
          <div></div>
        ...
        <v-row class="mt-4" justify="center">
          <p style="font-size:13px;font-weight: 500">لطفا صبر کنید</p>
        </v-row>
      </div>
